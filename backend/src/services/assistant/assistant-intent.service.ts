...
export function buildIntentInterpretationPrompt(question: string): string {
  return [
    ...
    '9. "unsupported": Any question outside project tracking, scheduling, or risk intelligence (e.g. "What is the weather?", "Who is the best contractor?", "What should we build next year?").',
    '',
    'CRITICAL BOUNDARIES:',
    ...
    '{',
    '  "intent": "delayed | at_risk | completed_today | behind_schedule | approaching_milestones | stale_activities | recent_changes | activity_status | unsupported",',
